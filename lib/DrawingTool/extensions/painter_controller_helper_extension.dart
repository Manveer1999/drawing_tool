...
/// Adds extra getters and setters in [DrawingToolController] to make it easier to use.
///
/// This was made as an extension to not clutter up the [DrawingToolController] class even more.
extension PainterControllerHelper on DrawingToolController {
