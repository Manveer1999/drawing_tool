...
/// An action of replacing a drawable with another in the [DrawingToolController].
class ReplaceDrawableAction extends ControllerAction<bool, bool> {
  ...
  @protected
  @override
  bool perform$(DrawingToolController controller) {
  ...
  @protected
  @override
  bool unperform$(DrawingToolController controller) {
    final value = controller.value;
