...
class GroupedAction extends ControllerAction<void, void> {
  ...
  late final List<ControllerAction<dynamic, dynamic>> actions;
  ...
  GroupedAction.from(ControllerAction<dynamic, dynamic> action1, ControllerAction<dynamic, dynamic> action2) {
    if (action1 is! GroupedAction && action2 is! GroupedAction) {
      actions = [action1, action2];
      return;
    }

    final List<ControllerAction<dynamic, dynamic>> previousActions, currentActions;
    final ControllerAction<dynamic, dynamic>? previousAction, currentAction;
    ...
    final ControllerAction<dynamic, dynamic>? merged;
  ...
  @protected
  @override
  void perform$(DrawingToolController controller) {
  ...
  @protected
  @override
  void unperform$(DrawingToolController controller) {
  ...
  @protected
  @override
  ControllerAction<dynamic, dynamic>? merge$(ControllerAction<dynamic, dynamic> previousAction) {
    if (actions.isEmpty) return previousAction;
    ControllerAction<dynamic, dynamic> toMerge;
    List<ControllerAction<dynamic, dynamic>> beforeMerge;
