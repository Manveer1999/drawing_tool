...
/// An action that can be performed in [DrawingToolController] which can be
...
abstract class ControllerAction<T, E> {
  ...
  T perform(DrawingToolController controller) {
  ...
  ///
  /// Returns any extra results from performing the action.
  E unperform(DrawingToolController controller) {
