...
class _TextWidgetState extends State<_TextWidget> {
  ...
  TextSettings get settings =>
      DrawingToolController.of(context).value.settings.text;
  ...
  void createDrawable() {
    ...
    DrawingToolController.of(context).addDrawables([drawable]);
...
class EditTextWidget extends StatefulWidget {
  /// The controller for the current [DrawingTool].
...
class EditTextWidgetState extends State<EditTextWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        //   fillValue: textEditingController.text,
  ...
  void onEditingComplete(String text) {
    if (text.trim().isEmpty) {
      ...
      widget.onTextDrawableCreated(drawable);
