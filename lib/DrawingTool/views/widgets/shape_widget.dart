...
class _ShapeWidgetState extends State<_ShapeWidget> {
  ...
  void onScaleStart(ScaleStartDetails details) {
    ...
    setState(() {
      DrawingToolController.of(context).addDrawables([shapeDrawable]);
  ...
  void onScaleEnd(ScaleEndDetails details) {
    ...
    if (settings.drawOnce) {
      DrawingToolController.of(context).settings =
          DrawingToolController.of(context).settings.copyWith(
                  shape: settings.copyWith(
                factory: null,
              ));
      SettingsUpdatedNotification(DrawingToolController.of(context).value.settings)
          .dispatch(context);
    }
