...
class ObjectWidgetState extends State<ObjectWidget> {
  ...
  List<ObjectDrawable> get drawables => DrawingToolController.of(context)
      .value
      .drawables
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timestamp) {
      controllerEventSubscription =
          DrawingToolController.of(context).events.listen((event) {
      ...
      DrawingToolController.of(context)
  ...
  void didChangeDependencies() {
    ...
    controller = DrawingToolController.of(context);
  }
                ...
                child: Container(
                  child: freeStyleSettings.mode != FreeStyleMode.none
                      ...
                      : MouseRegion(
                          ...
                          child: !widget.isInteractionEnabled ? const SizedBox() : GestureDetector(
                            behavior: widget.isInteractionEnabled ? HitTestBehavior.translucent : null,
                            onTap: () => widget.isInteractionEnabled ? tapDrawable(drawable) : null,
                              ...
                              child: selected
                                  ? Stack(
                                      children: [
                                              ...
                                              child: MouseRegion(
                                                ...
                                                child: GestureDetector(
                                                  ...
                                                  child: _ObjectControlBox(
                                                    ...
                                                    rotationScale: widget.rotationScale,
                                                  ),
                                                ),
                                              ),
                                            ),
                                        ...
                                        // if(entry.value is Sized2DDrawable && widget.isInteractionEnabled)...[
                                        //   Positioned(
                                        //     top: objectPadding - (controlsSize),
                                        //     left: (size.width / 2) +
                                        //         objectPadding -
  ...
  ObjectSettings get settings =>
      DrawingToolController.of(context).value.settings.object;
  ...
  FreeStyleSettings get freeStyleSettings =>
      DrawingToolController.of(context).value.settings.freeStyle;
  ...
  void tapDrawable(ObjectDrawable drawable, {bool openEditor = false}) {

    if (drawable.locked) return;

    widget.onItemTap(drawable, openEditor);
  ...
  void onDrawableScaleStart(
    ...
    if (!widget.isInteractionEnabled) return;
  ...
  Offset get center {
    final renderBox = DrawingToolController.of(context)
        .painterKey
        .currentContext
  ...
  void onTransformUpdated() {
    setState(() {
      final m4storage =
          DrawingToolController.of(context).transformationController.value;
...
class DotPlaceHolder extends StatelessWidget {
  const DotPlaceHolder({Key? key}) : super(key: key);
      ...
      child: Transform.scale(
        ...
        child: RotatedBox(
          ...
          child: AnimatedContainer(
            height: iconData != null ? 24 : 15,
            width: iconData != null ? 24 : 15,
